...
import com.example.sistemacompraventa_v2.CrearDomicilioActivity;
...
public class PerfilFragmento extends Fragment implements View.OnClickListener{
    ...
    private void showAddAddressScreen() {
        Intent crearDomiciliosIntent = new Intent( getActivity(), CrearDomicilioActivity.class );
        getActivity().startActivity( crearDomiciliosIntent );
    }
